...
"typical" to mean.
    ...
    With a sample that is skewed or has outliers, the median is a more accurate middle than the mean. In the case of a single 50 element sample, the median is more likely to give a better center. The median in this case is `r median(samp)`.
